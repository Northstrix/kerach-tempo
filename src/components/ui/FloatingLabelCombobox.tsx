...
import type { FloatingLabelInputProps } from './FloatingLabelInput';

interface FloatingLabelComboboxProps extends Omit<FloatingLabelInputProps, 'value' | 'onValueChange'> {
    label: string;
    value: string;
            ...
            <PopoverTrigger asChild>
                ...
                >
                    <FloatingLabelInput
                        ...
                        onValueChange={() => {}}
                        isComboboxFocused={open || isFocused}
                        readOnly
